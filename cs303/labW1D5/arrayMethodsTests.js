...
describe("groupById", function() {
  ...
  describe("copySorted", function () {
    it("returns corted copy of original array", function () {
        let arr = ["HTML","JavaScript","CSS"];

        assert.deepEqual(copySorted(arr), ["CSS","HTML","JavaScript"]);
    });

    it("Doesnt change the original array", function () {
        let arr = ["HTML","JavaScript","CSS"];
...
describe("sortByAge", function() {
    ...
    it("creates an object grouped by id", function() {
        let selam = { name: "Selam", age: 28 };
        let mahe = { name: "Mahe", age: 25 };
        let nahom = { name: "Nahom", age: 31};
        
        let arr = [ selam, mahe, nahom];
  ...
  describe("getAverageAge", function() {
    ...
    it("get average age from array of objects", function() {
      let users = [
        {name: 'Selam', age: 25},
        {name: 'Nahom', age: 28},
        {name: 'Mahe', age: 31},
