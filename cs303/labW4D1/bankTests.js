...
describe("CheckingAccount", () => {
    ...
    describe("toString() method", () => {
        it("returns a string representation of the SavingsAccount", () => {
            assert.equal("CheckingAccount 1: balance: -300 overdraft limit: 250", checking.toString());
        });
    });
    describe("endOfMonth() method", ()=>{
        it("returns a warning string when the balance is below zero", ()=>{
            assert.equal(checking.endOfMonth(), "Warning, low balance CheckingAccount 1:balance: -300 overdraft limit: 250");
        });
